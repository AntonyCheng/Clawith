        ...
        if v:
            ...
            if v.get("SYSTEM_EMAIL_FROM_ADDRESS") and v.get("SYSTEM_SMTP_HOST"):
                return SystemEmailConfig(
                    ...
                    from_name=str(v.get("SYSTEM_EMAIL_FROM_NAME", "DigitalEmployee")).strip() or "DigitalEmployee",
...
DEFAULT_EMAIL_TEMPLATES: dict[str, dict[str, str]] = {
    "email_verification": {
        "subject": "Verify your Digital Employee email address",
        "body": (
            "Hello {{display_name}},\n\n"
            "Welcome to Digital Employee! Please use the following 6-digit code to verify your email address:\n\n"
    ...
    "password_reset": {
        "subject": "Reset your Digital Employee password",
        "body": (
            "Hello {{display_name}},\n\n"
            "We received a request to reset your Digital Employee password.\n\n"
    ...
    "company_invitation": {
        "subject": "{{inviter_name}} invited you to join {{company_name}} on Digital Employee",
        "body": (
            "Hello,\n\n"
            "{{inviter_name}} has invited you to join their team '{{company_name}}' on Digital Employee.\n\n"
...
async def send_test_email(to: str, db=None) -> None:
    ...
    subject = "Digital Employee Test Email"
    body = (
