...
import UserAvatar from '../local/components/UserAvatar';
...
function AccountSettingsModal({ user, onClose, isChinese }: { user: any; onClose: () => void; isChinese: boolean }) {
    ...
    // 数字员工本地壳层：头像上传（后端为本地补的 /users/me/avatar 接口）。
                ...
                <div className="sidebar-top">
                    ...
                    <div className="sidebar-section" data-tour-target="main-nav">
                        ...
                        <NavLink key="roster" to="/roster" className={({ isActive }) => `sidebar-item ${isActive ? 'active' : ''}`}>
                            <span className="sidebar-item-icon" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <IconAddressBook size={14} stroke={1.5} />
                            </span>
                            <span className="sidebar-item-text">{t('nav.roster', '花名册')}</span>
                        </NavLink>
                    </div>
                </div>
                ...
                <div className="sidebar-bottom">
                    <div className="sidebar-footer">
                        <div className="sidebar-footer-controls" style={{
                            ...
                            {/* 数字员工本地壳层：主题锁定 light（main.tsx），不提供切换按钮 */}
                        ...
                        <div ref={accountMenuRef} style={{ position: 'relative' }}>
                            ...
                            >
                                {/* 数字员工本地壳层：用户头像（支持 avatar_url 展示） */}
                                <UserAvatar
