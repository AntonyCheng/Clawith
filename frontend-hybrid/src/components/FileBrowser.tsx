...
// 数字员工本地壳层：上传响应的 extraction 字段（对照 backend/app/services/text_extractor.py）。
// 仅被下方行内徽章消费。
...
export default function FileBrowser({
    ...
    // ─── Extraction badge helpers（数字员工本地壳层）────────
    ...
    // Persist the backend's `extraction` field so the file row can show an
