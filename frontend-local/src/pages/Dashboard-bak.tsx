        ...
        <div style={{
            ...
            {stats.map((s, i) => (
                <div key={i} style={{
                    ...
                    <div style={{
                        fontSize: '12px', color: '#000000', fontWeight: 700,
                        display: 'flex', alignItems: 'center', gap: '6px',
                        marginBottom: '4px',
                    }}>
                        <span style={{ display: 'flex', color: '#E60027' }}>{s.icon}</span> {s.label}
                    </div>
...
function AgentRow({ agent, tasks, recentActivity }: {
    ...
    const showAvatar = Boolean(agent.avatar_url) && !avatarFailed;
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
                <div style={{
                    ...
                    color: '#E60027', flexShrink: 0, overflow: 'hidden',
                }}>
                    {showAvatar ? (
                        <img
            ...
            {activities.map((act, i) => {
                ...
                return (
                    <div key={act.id || i} style={{
                        ...
                        <span style={{
                            fontSize: '11px', padding: '1px 6px',
                            borderRadius: 'var(--radius-sm)', background: 'rgba(230, 0, 39, 0.07)',
                            color: '#E60027', whiteSpace: 'nowrap', flexShrink: 0,
                            fontWeight: 500,
                        }}>
